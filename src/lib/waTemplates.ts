...
export interface WaTemplateDef {
  ...
  defaultBody: string
  module: 'appointments' | 'sales' | 'clientes' | 'encargos'  // which module this belongs to
...
¡Te extrañamos! ¿En qué podemos ayudarte hoy? 😊`,
  ...
  },
  {
    ...
    description: 'Se envía automáticamente cuando marcas un encargo como "Listo"',
    variables: ['nombre', 'negocio', 'articulo', 'codigo', 'total', 'link'],
    defaultBody: `Hola {{nombre}} 👋, tu encargo en *{{negocio}}* ya está *listo para recoger* ✅

📦 *{{articulo}}*
🔖 Código: {{codigo}}
💰 Total: {{total}}

Puedes hacer seguimiento en: {{link}}
