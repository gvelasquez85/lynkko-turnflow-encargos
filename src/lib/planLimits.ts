...
export const PLANS: Record<PlanKey, PlanDef> = {
  ...
  essential: {
    ...
    maxEstablishments: 2,
    maxUsers: 6,
    description: 'Hasta 2 sucursales y 6 usuarios',
    features: [
      'Hasta 2 sucursales · 6 usuarios',
      'Hasta 300 clientes',
      'Hasta 100 productos/servicios',
      'Registros de venta ilimitados',
      'Inventario básico',
      'Exportación Excel',
    ],
  },
  business: {
    ...
    maxEstablishments: 5,
    maxUsers: 16,
    description: 'Hasta 5 sucursales y 16 usuarios',
    highlighted: true,
    features: [
  ...
  enterprise: {
    ...
    maxUsers: 9999,
    description: 'Sucursales y usuarios ilimitados',
    features: [
